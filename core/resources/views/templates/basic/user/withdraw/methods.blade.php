    ...
    <div class="col-lg-6">
        <div class="card custom--card">
            <div class="card-header">
                <h6 class="card-title">@lang('Withdraw')</h6>
            </div>
            <div class="card-body">
                <form action="{{route('user.withdraw.money')}}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select form--control form--control--sm" name="method_code" required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="number" step="any" name="amount" value="{{ old('amount') }}" class="form-control form--control form--control--sm" required>
                    ...
                    <button type="submit" class="btn btn--base w-100 btn--sm mt-3">@lang('Submit')</button>
                </form>
            </div>
        </div>
    </div>
