        ...
        <div class="col-12">
            <div class="row gy-4">
                @if($user->is_author)
                    <div class="col-xxl-3 col-sm-6">
                        <div class="widget-two style--two box--shadow2 b-radius--5 bg--3">
                            ...
                            <div class="widget-two__content">
                                <h3 class="text-white">{{ @$user->products_count }}</h3>
                                <p class="text-white">@lang('Products')</p>
                            </div>
                            <a href="{{ route('admin.product.all') }}?author_id={{ $user->id }}" class="widget-two__btn">@lang('View All')</a>
                        </div>
                    </div>
                    <div class="col-xxl-3 col-sm-6">
                        <div class="widget-two style--two box--shadow2 b-radius--5 bg--18">
                            ...
                            <div class="widget-two__content">
                                <h3 class="text-white">{{ @$user->reviews_count }}</h3>
                                <p class="text-white">@lang('Reviews')</p>
                            </div>
                            <a href="{{ route('admin.review.index') }}?author_id={{ $user->id }}" class="widget-two__btn">@lang('View All')</a>
                        </div>
                    </div>
                    <div class="col-xxl-3 col-sm-6">
                        <x-widget
                    ...
                    <div class="col-xxl-3 col-sm-6">
                        <x-widget
                            link="{{ route('admin.sell.items', ['author_id' => $user->id]) }}"
                            style="3"
                            icon="la la-sellsy"
                            title="Sold Items"
                            value="{{ @$user->sold_items_count }}"
                            bg="12"
                        />
                    </div><!-- dashboard-w1 end -->
                @endif
