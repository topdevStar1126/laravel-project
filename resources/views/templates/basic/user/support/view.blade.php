                    ...
                    <div class="card custom--card">
                        ...
                        <div class="card-body">
                            <form method="post" action="{{ route('ticket.reply', $myTicket->id) }}" enctype="multipart/form-data">
                                ...
                                <div class="text-end">
                                    <a href="javascript:void(0)" class="btn btn-outline--base btn--sm addFile"><i class="las la-plus"></i> @lang('Add New')</a>
                                </div>
                                <div class="form-group">
            ...
            $('.addFile').on('click', function() {
                ...
                $("#fileUploadsContainer").append(`
                    <div class="input-group my-3">
                        ...
                        <button type="submit" class="input-group-text btn-outline--danger remove-btn ms-0"><i class="las la-times"></i></button>
                    </div>
                `)
            });
