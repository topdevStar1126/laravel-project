                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control form-control-lg" name="ftp[domain]" type="text" value="{{ @$general->ftp->domain }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control form-control-lg" name="ftp[host]" type="text" value="{{ @$general->ftp->host }}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-control-label font-weight-bold">@lang('Username')</label>
                                    <input class="form-control form-control-lg" name="ftp[username]" type="text" value="{{ @$general->ftp->username }}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-control-label font-weight-bold">@lang('Password')</label>
                                    <input class="form-control form-control-lg" name="ftp[password]" type="text" value="{{ @$general->ftp->password }}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-control-label font-weight-bold">@lang('Port')</label>
                                    <input class="form-control form-control-lg" name="ftp[port]" type="text" value="{{ @$general->ftp->port }}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-control-label font-weight-bold">@lang('Root Folder')</label>
                                    <input class="form-control form-control-lg" name="ftp[root]" type="text" value="{{ @$general->ftp->root }}">
                                </div>
                            </div>
                        </div>
