        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{ menuActive(['admin.sell.*'], 3) }}">
                        <i class="menu-icon la la-sellsy"></i>
                        <span class="menu-title">@lang('Manage Sales')</span>
                        @if ($refundedItemsCount)
                    ...
                    <div class="sidebar-submenu {{ menuActive(['admin.sell.*'], 2) }}">
                        <ul>
                            <li class="sidebar-menu-item {{ menuActive('admin.sell.items') }}">
                                <a href="{{ route('admin.sell.items') }}" class="nav-link ">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Sale Item')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{ menuActive('admin.sell.refunded') }}">
                                <a href="{{ route('admin.sell.refunded') }}" class="nav-link ">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Refunded Item')</span>
                                    @if ($refundedItemsCount)
                                        <span class="menu-badge pill bg--danger ms-auto">{{ $refundedItemsCount }}</span>
                                    @endif
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{ menuActive('admin.sell.all') }}">
                                <a href="{{ route('admin.sell.all') }}" class="nav-link ">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('All Sale')</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                        ...
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.product.pending') }} ">
                                <a href="{{ route('admin.product.pending') }}" class="nav-link">
                                    ...
                                    @if ($pendingProductsCount)
                                        <span class="menu-badge pill bg--danger ms-auto">{{ $pendingProductsCount }}</span>
                                    @endif
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{ menuActive('admin.product.soft.rejected') }} ">
                                <a href="{{ route('admin.product.soft.rejected') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Soft Rejected')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{ menuActive('admin.product.hard.rejected') }} ">
                                <a href="{{ route('admin.product.hard.rejected') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Hard Rejected')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{ menuActive('admin.product.down') }} ">
                                <a href="{{ route('admin.product.down') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Soft Disabled')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{ menuActive('admin.product.down.permanent') }} ">
                                <a href="{{ route('admin.product.down.permanent') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{ menuActive(['admin.category.*', 'admin.subcategory.*', 'admin.reviewcategory.*'], 3) }}">
                        <i class="menu-icon las la-list"></i>
                        <span class="menu-title">@lang('Manage Categories')</span>
                    </a>
                    <div class="sidebar-submenu {{ menuActive(['admin.category.*', 'admin.subcategory.*', 'admin.reviewcategory.*'], 2) }}">
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.reviewcategory.index') }}">
                                <a href="{{ route('admin.reviewcategory.index') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Review Categories')</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{ menuActive('admin.author.*', 3) }}">
                        ...
                        <span class="menu-title">@lang('Manage Author')</span>
                    </a>
                    <div class="sidebar-submenu {{ menuActive('admin.author.*', 2) }}">
                        <ul>
                            <li class="sidebar-menu-item {{ menuActive('admin.author.list') }}">
                                <a href="{{ route('admin.author.list') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Authors')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{ menuActive('admin.author.level.list') }}">
                                <a href="{{ route('admin.author.level.list') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Author Levels')</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{ menuActive(['admin.review.*', 'admin.comment.*'], 3) }}">
                        <i class="menu-icon las la-comments"></i>
                        <span class="menu-title">@lang('Review & Comment')</span>
                    </a>
                    <div class="sidebar-submenu {{ menuActive(['admin.review.*', 'admin.comment.*'], 2) }}">
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.comment.index') }}">
                ...
                <li class="sidebar-menu-item {{ menuActive('admin.setting.fees') }}">
                    <a href="{{ route('admin.setting.fees') }}" class="nav-link">
                        <i class="menu-icon las la-money-bill"></i>
                        <span class="menu-title">@lang('Manage Fees')</span>
                    </a>
                </li>
                ...
                <li class="sidebar-menu-item {{ menuActive('admin.setting.license') }}">
                    <a href="{{ route('admin.setting.license') }}" class="nav-link">
                        <i class="menu-icon las la-life-ring"></i>
                        <span class="menu-title">@lang('License Information')</span>
                    </a>
                </li>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a class="{{ menuActive('admin.storage.*', 3) }}" href="javascript:void(0)">
                        ...
                        <span class="menu-title">@lang('Storage Configure')</span>
                    </a>
                ...
                <li class="sidebar-menu-item {{ menuActive('admin.author.setting') }}">
                    <a href="{{ route('admin.author.setting') }}" class="nav-link">
                        <i class="menu-icon las la-user-cog"></i>
                        <span class="menu-title">@lang('Author Info Setting')</span>
                    </a>
                </li>
