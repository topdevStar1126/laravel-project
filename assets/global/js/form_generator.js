class FormGenerator{
    ...
    extraFields(fieldType){
        ...
        var html = '';
        // if select can multiple selection
          ...
          html += `
                ...
                <div class="mt-2">
                    <div class="form-group">
                        <select class="form-control simple" name="multi_select[]">
    ...
    formsToJson(form){
        ...
        var formItem = {
            ...
            multi_select:form.find('[name=multi_select]').val() ?? ''
        };
        return formItem;
    }
    ...
    makeFormHtml(formItem,updateId){
        ...
        var hiddenFields = `
            ...
            <input type="hidden" name="form_generator[multi_select][]" value="${formItem.multi_select}">
        `;
        var formsHtml = `
            ${hiddenFields}
            <div class="card-body">
    ...
    formEdit(element){
        ...
        form.find('[name=multi_select]').val(formItem.multi_select);
        ...
        if (formItem.type == 'file') {
            html += `
                ...
                <div class="mt-2">
                    <div class="form-group">
                        <select class="select2-multi-select extensions" name="extensions" multiple>
                            <option value="jpg">JPG</option>
                            <option value="jpeg">JPEG</option>
                            <option value="png">PNG</option>
                            <option value="pdf">PDF</option>
        ...
        $(".extra_area").find(".extensions").val(formItem.extensions);
        $(".extra_area").find("[name=multi_select]").val(formItem.multi_select);
    }
